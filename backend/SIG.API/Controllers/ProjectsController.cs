...
public class ProjectsController : ControllerBase
{
    ...
    public async Task<IActionResult> Create(ProjectCreateRequest req, CancellationToken ct)
    {
    ...
    [HttpPut("{id:int}")]
    [Authorize(Roles = "Administrator,Backoffice")]
    public async Task<IActionResult> Update(int id, ProjectUpdateRequest req, CancellationToken ct) =>
