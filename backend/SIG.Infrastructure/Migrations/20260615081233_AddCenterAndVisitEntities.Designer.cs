...
namespace SIG.Infrastructure.Migrations
{
    ...
    [Migration("20260615081233_AddCenterAndVisitEntities")]
    partial class AddCenterAndVisitEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SIG.Domain.Entities.Center", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("CentroIdExterno")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("centro_id_externo");
                    ...
                    b.Property<string>("Enseña")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("enseña");
                    ...
                    b.HasIndex("CentroIdExterno")
                        .IsUnique()
                        .HasDatabaseName("ix_centers_centro_id_externo");
            ...
            modelBuilder.Entity("SIG.Domain.Entities.Visit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("CenterId")
                        .HasDatabaseName("ix_visits_center_id");

                    b.HasIndex("ServiceId")
                        .HasDatabaseName("ix_visits_service_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_visits_user_id");

                    b.HasIndex("VisitaIdExterno")
                        .IsUnique()
                        .HasDatabaseName("ix_visits_visita_id_externo");
            ...
            modelBuilder.Entity("SIG.Domain.Entities.Visit", b =>
                {
                    b.HasOne("SIG.Domain.Entities.Center", "Center")
                        .WithMany("Visits")
                        .HasForeignKey("CenterId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_visits_centers_center_id");

                    b.HasOne("SIG.Domain.Entities.Service", "Service")
                        .WithMany()
                        .HasForeignKey("ServiceId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_visits_services_service_id");
