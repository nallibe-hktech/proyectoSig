...
{
    /// <inheritdoc />
    public partial class AddA3InnuvaNominasStaging : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "staging_a3innuva_companies",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_staging_a3innuva_companies", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "staging_a3innuva_payrolls",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_staging_a3innuva_payrolls", x => x.id);
                });
        }
